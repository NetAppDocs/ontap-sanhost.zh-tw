...
您必須驗證組態是否符合系統需求。如需詳細資訊、請參閱 https://mysupport.netapp.com/matrix/imt.jsp?components=65623;64703;&solution=1&isHWU&src=IMT["NetApp 互通性對照表工具"^] 以及Veritas HCL Matrix。
