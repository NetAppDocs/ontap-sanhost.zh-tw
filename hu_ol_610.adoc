...
NOTE: 若要設定 Oracle Linux 6.10 Red Hat 相容核心（ RHCK ），請使用link:hu_rhel_610.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 6.10 的。
...
NOTE: 如需 Oracle Linux RHCK 已知問題，請參閱link:hu_rhel_610.html#known-problems-and-limitations["已知問題"]適用於 RHEL 6.10 的。
