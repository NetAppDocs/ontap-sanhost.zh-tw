...
NOTE: 若要設定 Oracle Linux 8.1 Red Hat 相容核心（ RHCK ），請使用link:hu_rhel_81.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 8.1 的。
...
NOTE: 如需 Oracle Linux RHCK 已知問題，請參閱link:hu_rhel_81.html#known-problems-and-limitations["已知問題"]適用於 RHEL 8.1 的。
