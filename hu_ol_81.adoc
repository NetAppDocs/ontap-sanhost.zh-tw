...
ONTAP 版本的 Oracle Linux 8.1 沒有已知問題。


NOTE: 對於 Oracle Linux （ Red Hat 相容核心）已知問題，請參閱link:hu_rhel_81.html#known-problems-and-limitations["已知問題"]適用於 Red Hat Enterprise Linux （ RHEL ） 8.1 的。
