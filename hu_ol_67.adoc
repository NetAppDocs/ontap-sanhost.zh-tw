...
[role="lead"]
您可以使用 ONTAP SAN 主機組態設定、將 Oracle Linux 6.7 與 ONTAP 設定為目標。
...
NOTE: 若要設定 Oracle Linux 6.7 Red Hat Enterprise 核心（ RHCK ）、請使用link:hu_rhel_67.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 6.7 的。



== 已知問題

使用 ONTAP 版本的 Oracle Linux 6.7 沒有已知問題。
