...
| link:https://mysupport.netapp.com/NOW/cgi-bin/bol?Type=Detail&Display=852674["1076584"^] | 在 RHEL 6U4 儲存設備故障期間， QLogic 16G FC （ QLE2672 ）主機的 I/O 停止達 300 秒 | 在儲存 / 光纖網路故障期間，您可能會在 QLogic 16G FC （ QLE2672 ）主機上觀察到 I/O 停止達 300 秒。 
