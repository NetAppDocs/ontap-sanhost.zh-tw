...
summary: 配置 Citrix Hypervisor 8.4 以實現多路徑，並使用特定參數和設定來針對ONTAP儲存的 FCP 和 iSCSI 協定操作。 
---
...
[role="lead"]
配置 Citrix Hypervisor 8.4 以實現多路徑，並使用特定參數和設定來針對ONTAP儲存的 FCP 和 iSCSI 協定操作。
...
您可以使用 Citrix Hypervisor 8.4 的多路徑來管理ONTAP LUN。
