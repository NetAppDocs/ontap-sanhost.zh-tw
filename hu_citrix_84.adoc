...
summary: 介紹如何將 Citrix XenServer 8.4 與 ONTAP 結合使用 
---
...
[role="lead"]
Linux 主機公用程式軟體可為連接至 ONTAP 儲存設備的 Linux 主機提供管理與診斷工具。在 Citrix Xenserver 8.4 主機上安裝 Linux Host Utilities 時，您可以使用 Host Utilities 來協助您管理 ONTAP LUN 的 FCP 和 iSCSI 協定操作。
...
您可以使用 Citrix Xenserver 8.4 的多路徑來管理 ONTAP LUN。
