...
** NetApp 支援使用 Solaris 虛擬化技術，其中整體組態由 Oracle 支援，並且任何可直接存取 LUN 的分區都列在link:https://imt.netapp.com/matrix/#welcome["IMT"^]支援的組態中。這包括根目錄容器、LDOM I/O 域以及使用 NPIV 存取 LUN 的 LDOM。
