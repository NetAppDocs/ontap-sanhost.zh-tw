...
summary: 說明如何搭配ONTAP 使用Oracle Linux 8.4搭配使用 
---
...
NOTE: 若要設定 Oracle Linux 8.4 Red Hat Enterprise 核心（ RHHCK ）、請使用link:hu_rhel_84.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 8.4 的。
...
使用 ONTAP 版本的 Oracle Linux 8.4 沒有已知問題。


NOTE: 如需Oracle Linux（Red Hat相容核心）已知問題、請參閱 link:hu_rhel_84.html#known-problems-and-limitations["已知問題"] 相關Red Hat Enterprise Linux版本文件中的一節。
