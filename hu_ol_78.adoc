...
summary: 在 Oracle Linux 7.8 主機上安裝 Linux Host Utilities 以使用 ONTAP LUN 管理 FCP 和 iSCSI 協定操作。 
---
...
NOTE: 您可以使用link:hu_rhel_78.html#rhel-rhck["Red Hat Enterprise Linux (RHEL) 7.8 的建議設置"]為 Oracle Linux 7.8 配置 Red Hat 相容核心。
