...
了解如何為 Red Hat Enterprise Linux (RHEL) 9.5 設定 NVMe over Fabrics (NVMe-oF) 主機。有關更多支援和功能信息，請參閱link:hu-nvme-index.html["NVME-oF 概述"^]。

RHEL 9.5 的 NVMe-oF 沒有已知的限制。
...
.步驟
. 在伺服器上安裝 RHEL 9.5。安裝完成後，請驗證您是否正在執行所需的 RHEL 9.5 核心：
+
[source, cli]
----
uname -r
