...
.步驟
. 在伺服器上安裝 RHEL 8.6 。安裝完成後、請確認您正在執行指定的 RHEL 8.6 核心。如需支援版本的最新清單，請參閱link:https://mysupport.netapp.com/matrix/["互通性對照表工具"^]。
. 安裝完成後、請確認您正在執行指定的 RHEL 8.6 核心。如需支援版本的最新清單，請參閱link:https://mysupport.netapp.com/matrix/["互通性對照表工具"^]。
+
範例：
