...
NOTE: 若要設定 Oracle Linux 8.7 Red Hat Enterprise 核心（ RHHCK ）、請使用link:hu_rhel_87.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 8.7 的。
...
使用 ONTAP 版本的 Oracle Linux 8.7 沒有已知問題。
