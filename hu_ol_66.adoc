...
---
= 使用Oracle Linux 6.6搭配NetApp ONTAP 功能
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
.您需要的產品
如果您決定使用SAN開機、則組態必須支援SAN開機。您可以使用 https://mysupport.netapp.com/matrix/imt.jsp?components=74908;74907;71545;71546;69941;69939;69940;&solution=1&isHWU&src=IMT["NetApp 互通性對照表工具"^] 驗證是否ONTAP 支援您的作業系統、HBA、HBA韌體和HBA開機BIOS及BIOS版本。
...
NOTE: 若要設定Oracle Linux 6.6 RedHat Enterprise核心（RHCK）、請使用 link:hu_rhel_66.html#recommended-settings["建議設定"] 適用於Red Hat Enterprise Linux（RHEL）6.6。
...
NOTE: 如需Oracle Linux（Red Hat相容核心）已知問題、請參閱 link:hu_rhel_66.html#known-problems-and-limitations["已知問題"] 適用於Red Hat Enterprise Linux（RHEL）6.6。
