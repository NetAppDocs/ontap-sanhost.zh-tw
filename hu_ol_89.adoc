...
NOTE: 單一 LUN 不應需要四條以上的路徑。在儲存設備故障期間、可能會有八個以上的路徑發生問題。
...
NOTE: 若要設定 Oracle Linux 8.9 RedHat Enterprise 核心、請使用link:hu_rhel_88.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 8.9 的。
