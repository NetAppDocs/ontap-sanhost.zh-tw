...
ONTAP 版本的 Oracle Linux 8.6 沒有已知問題。


NOTE: 對於 Oracle Linux （ Red Hat 相容核心）已知問題，請參閱link:hu_rhel_86.html#known-problems-and-limitations["已知問題"]相應 Red Hat Enterprise Linux 版本文件中的一節。
