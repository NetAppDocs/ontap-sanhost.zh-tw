...
---
= 使用Red Hat Enterprise Linux 8.2搭配NetApp ONTAP 功能
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
對於Red Hat Enterprise Linux（RHEL）8.2、/etc/multipath.conf檔案必須存在、但您不需要對檔案進行特定變更。RHEL 8.2已使用所有必要設定進行編譯、以辨識及正確管理ONTAP 各種LUN。
