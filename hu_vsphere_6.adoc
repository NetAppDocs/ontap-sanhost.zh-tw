...
如需有關資源配置和管理 vVols 的詳細資訊，請參閱適用於 VMware vSphere 的 ONTAP 工具文件， https://docs.netapp.com/us-en/netapp-solutions/virtualization/vsphere_ontap_ontap_for_vsphere.html["TR-4597"^]以及和link:https://www.netapp.com/pdf.html?item=/media/13555-tr4400pdf.pdf["TR-4400."^]
