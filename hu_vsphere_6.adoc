...
如需資源配置與管理vVols的詳細資訊、請參閱ONTAP VMware vSphere的VMware工具文件及 link:https://docs.netapp.com/us-en/netapp-solutions/hybrid-cloud/vsphere_ontap_ontap_for_vsphere.html["TR-4597"^] 和 link:https://www.netapp.com/pdf.html?item=/media/13555-tr4400pdf.pdf["TR-4400."^]
...
* 若要使用TR-4597- VMware vSphere ONTAP 搭配VMware vCenter、請參閱 link:https://cert.vmware.com/caas/support/case/00088028["客戶案例：00088028"^] 和 link:https://cert.vmware.com/caas/support/case/00088029["客戶案例：00088029"^]
