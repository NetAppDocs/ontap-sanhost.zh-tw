...
---
= 使用Oracle Linux 7.0搭配NetApp ONTAP 功能
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: 若要設定Oracle Linux 7.0 RedHat Enterprise核心（RHCK）、請使用 link:hu_rhel_70.html#recommended-settings["建議設定"] 適用於Red Hat Enterprise Linux（RHEL）7.0。
...
NOTE: 如需Oracle Linux（Red Hat相容核心）已知問題、請參閱 link:hu_rhel_70.html#known-problems-and-limitations["已知問題"] 適用於Red Hat Enterprise Linux（RHEL）7.0。
