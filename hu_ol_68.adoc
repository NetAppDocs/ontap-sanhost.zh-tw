...
[role="lead"]
您可以使用 ONTAP SAN 主機組態設定、將 ONTAP 設定為目標的 Oracle Linux 6.8 。
...
NOTE: 若要設定 Oracle Linux 6.8 Red Hat Enterprise 核心（ RCK ）、請使用link:hu_rhel_68.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 6.8 的。



== 已知問題

使用 ONTAP 版本的 Oracle Linux 6.8 沒有已知問題。
