...
---
= 搭配ONTAP 使用Windows Server 2022搭配使用
:toc: macro
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
...
NOTE: 前往 link:https://www.catalog.update.microsoft.com/Search.aspx?q=update%20%22windows%20server%202022%22["Microsoft Update目錄2022"^] 網站、取得並安裝適用於您Windows版本的必要Windows修補程式。
...
NOTE: 當您選取MPIO支援時、Windows Unified Host Utilities會啟用Windows Server 2022隨附的MPIO功能。
