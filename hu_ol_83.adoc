...
NOTE: 若要設定 Oracle Linux 8.3 Red Hat Enterprise 核心（ RCK ），請使用link:hu_rhel_83.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 8.3 的。



== 已知問題

ONTAP 版本的 Oracle Linux 8.3 沒有已知問題。


NOTE: 對於 Oracle Linux （ Red Hat 相容核心）已知問題，請參閱link:hu_rhel_83.html#known-problems-and-limitations["已知問題"]相應 Red Hat Enterprise Linux 版本文件中的一節。
