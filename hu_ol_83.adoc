...
NOTE: 若要設定 Oracle Linux 8.3 Red Hat 相容核心（ RHCK ），請使用link:hu_rhel_83.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 8.3 的。
...
NOTE: 有關 Oracle Linux RHCK 已知問題，請參閱link:hu_rhel_83.html#known-problems-and-limitations["已知問題"]對應 RHEL 版本文件中的一節。
