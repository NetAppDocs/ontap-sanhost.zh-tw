...
.您需要的產品
NetApp Linux Unified Host Utilities軟體套件可在上取得 link:https://mysupport.netapp.com/site/["NetApp 支援網站"^] 在32位元或64位元.rpm檔案中。
...
. 從下載32位元或64位元Linux Unified Host Utilities軟體套件 link:https://mysupport.netapp.com/site/["NetApp 支援網站"^] 到您的主機。
