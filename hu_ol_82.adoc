...
NOTE: 若要設定 Oracle Linux 8.2 Red Hat Enterprise 核心（ RHHCK ）、請使用link:hu_rhel_82.html#recommended-settings["建議設定"]適用於 Red Hat Enterprise Linux （ RHEL ） 8.2 的。



== 已知問題

使用 ONTAP 版本的 Oracle Linux 8.2 沒有已知問題。


NOTE: 如需Oracle Linux（Red Hat相容核心）已知問題、請參閱 link:hu_rhel_82.html#known-problems-and-limitations["已知問題"] 適用於Red Hat Enterprise Linux（RHEL）8.2。
